...
def TEST(self, a, reject_rate, avg_wait, pre_reject, num_disp, idxx, reject_rate_h, idle_taxi_h,
    ...
    disp_actor_name = 'episode_5185actor'
    ...
    while self.RealExpTime <= EndTime:
        ...
        for idx in seq:
            ...
            for vehicle in cluster.IdleVehicles:
                ...
                disp_state = Disp_GetStateFunction(self, cluster, pre_idxs2)
...
save_path2 = os.path.join("../","Models","Pre_baseline", "_", "saves_episode", "VeRL0-" + args.name)
