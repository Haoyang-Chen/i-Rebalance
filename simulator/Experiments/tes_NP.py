...
def TEST(self, a, reject_rate, avg_wait, pre_reject, num_disp, idxx, reject_rate_h, idle_taxi_h,
    ...
    disp_actor_name = 'episode_7220actor'
    ...
    seq_actor_name = 'episode_9995actor7'
...
save_path2 = os.path.join("../","Models","Disp_A2C_NP", "_", "saves_episode", "VeRL0-" + args.name)
EPS = 6 * 10
